...
namespace {
const std::string METRIC_ZILLIQA_PROVIDER{"NONE"};
...
std::string METRIC_ZILLIQA_MASK{"NONE"};
const std::string TRACE_ZILLIQA_PROVIDER{"NONE"};
...
std::string TRACE_ZILLIQA_MASK{"NONE"};
