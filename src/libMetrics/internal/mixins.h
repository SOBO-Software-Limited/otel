...
class DoubleHistogram {
 public:
  DoubleHistogram(zil::metrics::FilterClass fc, const std::string &name, const std::list<double> &boundaries, const std::string &description, const std::string &units)
...
class DoubleGauge {
 public:
  DoubleGauge(zil::metrics::FilterClass fc, const std::string &name, const std::string &description,
