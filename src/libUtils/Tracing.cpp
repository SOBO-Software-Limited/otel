...
namespace {
    ...
    const int TRACE_ZILLIQA_PORT{8090};
    const std::string TRACE_ZILLIQA_SCHEMA_VERSION{"1.2.0"};
    const std::string TRACE_ZILLIQA_SCHEMA{"https://opentelemetry.io/schemas/1.2.0"};
